...
3. 승인되면 손님이 **영수증을 받은 매장을 제외한** 두 매장의 무료 사이드 목록에서 하나를 고르고, 쿠폰(6자리 코드)이 쿠폰함에 들어간다. 사이드를 고를 수 있는 기간은 승인일부터 쿠폰 유효일(기본 30일)과 같고, 쿠폰은 발급일 기준 N일 뒤 그날 23:59(KST)까지 쓸 수 있다. 승인된 결제 금액은 누적되어 등급(단골/VIP/VVIP)이 오른다.
