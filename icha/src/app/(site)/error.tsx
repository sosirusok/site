  ...
  return (
    <div className={`wrap ${styles.wrap}`}>
      <div className={`paper ${styles.paper}`}>
        <p className={`mono ${styles.code}`}>오류</p>
        <h1 className={`serif ${styles.title}`}>화면을 그리다<br />막혔어요.</h1>
        ...
        <div className={styles.actions}>
          <button type="button" className="btn btn-block" onClick={() => retry()}>다시 시도</button>
