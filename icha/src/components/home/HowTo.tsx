 ...
 */
/** [쿠폰함 열기]는 늘 /wallet — 로그인 전이면 proxy 가 /login?next=/wallet 로 보낸다(홈은 정적이라 세션을 모른다) */
  ...
  return (
    <section className={s.how} aria-labelledby="how-title">
      ...
      <div className={s.noteRow}>
        ...
        />
        <StickerButton kind="wallet" href="/wallet" tilt={-1} className={s.walletBtn} style={{ "--r": "-2deg" } as CSSProperties}>쿠폰함 열기</StickerButton>
      </div>
