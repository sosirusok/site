 ...
 * 세 매장 각각 [예약하기] [플레이스 열기] [리뷰] [길찾기]. 링크는 새 창(네이버 앱이 있으면 앱으로).
 */
  ...
  return createPortal(
    <div className={styles.backdrop} onClick={onClose} role="presentation">
      <div className={`${styles.sheet}`} role="dialog" aria-modal="true" aria-label="네이버 플레이스" onClick={(e) => e.stopPropagation()}>
        ...
        <a className="btn btn-secondary btn-block" href={naverSearchUrl(SEARCH_QUERY)} target="_blank" rel="noreferrer">네이버에서 ‘알콜부시기’ 검색</a>
