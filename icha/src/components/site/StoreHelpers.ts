...
export const STORE_COPY: Record<StoreId, StoreCopy> = {
  joseon: {
    ...
    intro: "통나무 건물 1·2층을 쓰고 2층은 좌식이에요. 전 다섯 가지 모듬과 양은 통 막걸리가 주력이에요.",
  },
  tokyo: {
    headline: "서서 마시는 산토리 공식 생맥주 집이에요.",
    intro: "2026년 9월에 연 일본식 타치노미예요. 생맥주는 한 잔 8,900원, 안주는 콜드햄 플레이트가 중심이에요.",
  },
  wareureu: {
    headline: "식사도 안주도 되는 한식요리주점이에요.",
    intro: "메뉴가 일흔 가지가 넘어요. 마흔 명까지 앉을 수 있고 주문은 테이블 태블릿으로 해요.",
  },
};
