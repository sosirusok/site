...
export const LOCATIONS: Record<StoreId, StoreLocation> = {
  joseon: {
    ...
    directions: "서면 밀리오레 맞은편 골목으로 들어와 다이닝캠프 옆 건물이에요. 1층과 2층(좌식)을 같이 써요.",
    floor: "1·2층",
  ...
  tokyo: {
    ...
    directions: "서면 젊음의 거리 골목이에요. 파란 간판과 '산토리 공식매장' 노렌이 걸린 1층 매장이에요.",
    floor: "1층",
    landmarks: ["서면 젊음의 거리"],
    parking: "주차 불가",
  },
  wareureu: {
    ...
    directions: "서면2번가 해피통닭 바로 옆 건물 2층이에요. 불로장생을 바라보고 오른쪽 골목으로 들어오면 돼요.",
    floor: "2층",
